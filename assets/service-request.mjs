...
<div class="services-route" aria-label="Helping Hands lawn care services">
  ...
  <article class="route-stop stop-mow reveal">
  ...
  <article class="route-stop stop-edge reveal">
    <div class="route-stop-top">
      <span class="route-icon" aria-hidden="true">
  ...
  <article class="route-stop stop-cleanup reveal">
    <div class="route-stop-top">
      <span class="route-icon" aria-hidden="true">
  ...
  <article class="route-stop stop-recurring reveal">
    <div class="route-stop-top">
      <span class="route-icon" aria-hidden="true">
...
function initPageEnhancements(doc = document) {
  applyComparisonTitleContrast(doc);
  initServiceRoute(doc);
}

if (typeof document !== "undefined") {
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", () => initPageEnhancements(document), { once: true });
  } else {
